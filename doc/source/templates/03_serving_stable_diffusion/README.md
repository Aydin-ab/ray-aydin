...
| Time to Run | Around 2 minutes to setup the models and generate your first images. Less than 10 seconds for every subsequent round of image generation (depending on the image size). |
...
4. Click the `/imagine` endpoint, then "Try it out" to enable calling it through the interactive API browser.
